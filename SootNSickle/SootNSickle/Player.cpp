...
bool Player::initialize(SootNSickle * g, Controls c,TextDX* t, int width, int height, int ncols, TextureManager *playerTM, TextureManager *feetTM,TextureManager *cylinderTM)
{
	game = g;
	controls = c;
	text = t;
